  ...
  return (
    <div>
      ...
      <GatedContent title="KHO BÁU DÀNH RIÊNG CHO THÀNH VIÊN"
        ...
        {/* Videos */}
        <section className="bg-blue-50 dark:bg-card py-16 relative overflow-hidden">
        ...
        <section className="bg-moodoo-cream py-16 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {emotions.map((e, i) => (
                <motion.div key={i} className={`bg-white dark:bg-card text-center p-6 rounded-2xl border-4 ${e.color} hover:scale-105 transition-transform cursor-pointer`}
                  initial="hidden" whileInView="visible" viewport={{ once: true }}
        ...
        {/* Ebooks */}
        <section className="bg-pink-50 dark:bg-card py-16">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-10">
              {ebooks.map((eb, i) => (
                <a key={i} href={eb.url} target="_blank" rel="noopener noreferrer"
                  className="block w-56 mx-auto bg-white dark:bg-card rounded-2xl p-8 border-2 border-moodoo-rose shadow-[0_8px_0_hsl(var(--moodoo-rose))] hover:translate-y-1 hover:shadow-[0_4px_0_hsl(var(--moodoo-rose))] transition-all text-center">

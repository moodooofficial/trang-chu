...
import { supabase } from "@/integrations/supabase/client"; // Import supabase để check auth
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-80">
              ...
              {/* Sửa logic hiển thị link App tại đây */}
              <li>
                {isLoggedIn ? (
                  <a href="/app" className="hover:opacity-100 hover:underline transition-opacity">{t.app}</a>
                ) : (
                  <span className="opacity-50 cursor-not-allowed" title="Vui lòng đăng nhập để sử dụng">{t.app} 🔒</span>
                )}
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              {/* Giữ nguyên các link social của bạn */}
